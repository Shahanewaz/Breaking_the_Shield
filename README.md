...
<p align="center">
  <img src="assests/mis_dis.png" width="60%" alt="Misinformation and Disinformation">
</p>

<p align="justified">
  Illustrations of potentially harmful outputs {\color{black} generated by GPT-4o web inference}. (a) shows misinformation in the form of incorrect facts, while (b) presents biased or discriminatory responses based on demographic attributes.
</p>
